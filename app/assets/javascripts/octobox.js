var Octobox = (function() {
  ...
  var initialize = function() {
    ...
    this.enableTooltips();
    this.updateFavicon();
    this.initShiftClickCheckboxes()
    this.recoverPreviousCursorPosition();
    this.setAutoSyncTimer();

    // Sync Handling
    if($(".js-is_syncing").length){ this.refreshOnSync() }
    if($(".js-start_sync").length){ this.sync() }
    if($(".js-initial_sync").length){ Octobox.sync() }
  }
  ...
  return {
    ...
    sync: sync,
    recoverPreviousCursorPosition: recoverPreviousCursorPosition,
    markRowCurrent: markRowCurrent,
    initShiftClickCheckboxes: initShiftClickCheckboxes,
    toggleStarClick: toggleStarClick,
    changeArchive: changeArchive,
    initialize: initialize,
    setAutoSyncTimer: setAutoSyncTimer,
